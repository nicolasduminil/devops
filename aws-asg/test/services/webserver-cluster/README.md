# Web server cluster example (test environment)

This folder contains an example [Terraform](https://www.terraform.io/) template that deploys a cluster of web servers 
